...
and a value and returns the array passed to the function 
...
and returns a new array with all the values 
in the array passed to the function doubled
...
and lowercased) removed. Every character in the new string should be lowercased.
